...
div.vue-form-generator(v-if='schema != null')
	fieldset(v-if="schema.fields", :is='tag')
		template(v-for='field in fields')
			form-group(v-if='fieldVisible(field)', :vfg="vfg", :field="field", :errors="errors", :model="model", :options="options", @validated="onFieldValidated", @model-updated="onModelUpdated", @help-click="onHelpClick")
...
export default {
	...
	methods: {
		...
		onHelpClick(vfg, field) {
			this.$emit("help-click", vfg, field);
		},
